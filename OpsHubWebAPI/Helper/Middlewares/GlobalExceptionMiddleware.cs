...
namespace STEIWebAPI.Helper
{
    public class GlobalExceptionMiddleware
    {
        ...
        public GlobalExceptionMiddleware(RequestDelegate next,ILoggerManager loggerManager)
        {
            _next = next;
        ...
        private async Task HandleExceptionAsync(HttpContext context, Exception ex)
        {
            ...
            if (ex is UnauthorizedAccessException unauthorizedEx)
            {
                ...
                errorResult = new
                {
                    ...
                    BusinessErrorMessage = "Invalid Token or Token Expired."
                };
            }
            else 
            {
            ...
            await context.Response.WriteAsync(JsonSerializer.Serialize((object)errorResult));
        }
        ...
        private string GetExceptionSourceDetails(Exception ex)
        {
            ...
            var userNamespaces = new[] { "OpsHubBAL", "OpsHubWebAPI", "OpsHubDAL" };
