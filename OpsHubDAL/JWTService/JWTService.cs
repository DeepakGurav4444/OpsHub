...
namespace OpsHubDAL.JWTService
{
    public class JWTService : IJWTService
    {
        ...
        public JWTService(IConfiguration configuration, IOpsHubContext opsHubContext,ILoggerManager loggerManager) 
        {
        ...
        public string GenerateToken(string type,int UserId,int TenantId,int ModuleId, int roleId, List<string> permissions)
        {
